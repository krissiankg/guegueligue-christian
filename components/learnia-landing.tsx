...
const steps = [
  { title: 'Understand n8n', description: 'The visual language of workflows', duration: '12 min' },
  { title: 'Build your first workflow', description: 'From trigger to action', duration: '18 min' },
  { title: 'Connect external services', description: 'Make your tools work together', duration: '24 min' },
  { title: 'Add AI to your workflow', description: 'Bring intelligence into the loop', duration: '31 min' },
  { title: 'Build a real-world project', description: 'Apply everything you have learned', duration: '45 min' },
]
